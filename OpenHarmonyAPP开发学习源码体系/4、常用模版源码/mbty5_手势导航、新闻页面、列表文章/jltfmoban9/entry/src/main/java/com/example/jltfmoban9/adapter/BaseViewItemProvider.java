...
public abstract class BaseViewItemProvider extends BaseItemProvider {
    private final int crossNumber = 2;
    ...
    public Component getComponent(int position, Component component, ComponentContainer componentContainer) {
        ...
        if (component != null) {
            ...
            for (int i = 0; i < parentLayout.getChildCount(); i = i + crossNumber) { // crossNumber for adding divider
                Item itemInGroup = item.getGroup().get(i / crossNumber);
     ...
     */
    protected abstract void dealWithItem(ComponentContainer parentLayout, Component component,
                                         ComponentContainer componentContainer, Item item, int positionInGroup, int position);
