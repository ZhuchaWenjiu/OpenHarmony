package com.example.jltfmoban9.model;
...
public class Item {
     ...
     * @param itemType            itemType
     */
    public Item(int logoImageId, int checkBoxId, String itemName,
                String itemNameDescription, int itemLayoutId, int itemType) {
        this.logoImageId = logoImageId;
        this.checkBoxId = checkBoxId;
        this.itemName = itemName;
        this.statusDescription = itemNameDescription;
