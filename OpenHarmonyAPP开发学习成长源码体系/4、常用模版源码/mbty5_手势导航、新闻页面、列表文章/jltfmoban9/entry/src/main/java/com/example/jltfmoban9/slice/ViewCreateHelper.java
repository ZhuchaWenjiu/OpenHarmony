...
import com.example.jltfmoban9.adapter.CustomPageSliderProvider;
import com.example.jltfmoban9.adapter.ListViewItemProvider;
import com.example.jltfmoban9.adapter.SliderListener;
import com.example.jltfmoban9.model.Item;
import com.example.jltfmoban9.utils.AppUtils;
...
public class ViewCreateHelper implements Component.ClickedListener {
    ...
    private List<Item> initListViewData() {
        ...
        for (int i = 0; i < LIST_NUMBER; i++) {
            int idx = i * 2;
            Item dataItem =
                    new Item(AppUtils.getStringResource(rootLayout, resourceIdList[idx]),
    ...
    private List<Component> initPageSliderData() {
        ...
        int[][] resourceID = {
                {ResourceTable.Media_slide_right, ResourceTable.String_page_description_0,
                        ResourceTable.String_page_description_bot_0},
                {ResourceTable.Media_slide_left, ResourceTable.String_page_description_1,
                        ResourceTable.String_page_description_bot_1},
                {ResourceTable.Media_slide_up, ResourceTable.String_page_description_2,
